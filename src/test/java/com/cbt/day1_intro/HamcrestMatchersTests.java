...
public class HamcrestMatchersTests {
    ...
    public void test(){
        ...
        // matcherAssert help for the readabilities
         // String
        String one = "abc";
        String two = "abc";
        String three = " abc";
        ...
        assertThat(words,contains("Larry","Moe","Curly")); // should contains all items
        assertThat(words,containsInAnyOrder("Larry","Moe","Curly"));
